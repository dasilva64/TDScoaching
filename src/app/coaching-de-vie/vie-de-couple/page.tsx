        ...
        <section className={styles.couple__why}>
          <div className={styles.couple__why__container}>
            ...
            <p>
              ...
              traverser l’impasse pour en sortir encore plus fort. L’un des
              moyens privilégiés des couples pour avoir l’aide ou
              l’accompagnement nécessaire aux changements souhaités est d’avoir
              recours à un coach conjugal.
            </p>
          </div>
        </section>
