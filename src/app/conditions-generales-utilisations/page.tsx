  ...
  return (
    <>
      ...
      <main className={styles.cgu}>
        <h1 className={styles.cgu__h1}>
          Conditions générales d&apos;utilisations
        </h1>
        <h2 className={styles.cgu__h2}>Définitions</h2>
        ...
        <h2 className={styles.cgu__h2}>1. Présentation du site internet.</h2>
        <p className={styles.cgu__p}>
        ...
        <h2 className={styles.cgu__h2}>3. Description des services fournis.</h2>
        <p className={styles.cgu__p}>
          Le site internet{" "}
          <Link className={styles.cgu__link} href="https://tdscoaching.fr/">
            https://tdscoaching.fr/
        ...
        <h2 className={styles.cgu__h2}>6. Limitations de responsabilité.</h2>
        <p className={styles.cgu__p}>
          <Link className={styles.cgu__link} href="https://tdscoaching.fr/">
            https://tdscoaching.fr/
          </Link>{" "}
        ...
        <h2 className={styles.cgu__h2}>7. Gestion des données personnelles.</h2>
        <p className={styles.cgu__p}>
        ...
        <p className={styles.cgu__p}>
          ...
          est représenté par dsfsf, son représentant légal
        </p>
        <p className={styles.cgu__p}>
        ...
        <h3 className={styles.cgu__h3}>7.2 Finalité des données collectées</h3>
        <p className={styles.cgu__p}>
          <Link className={styles.cgu__link} href="https://tdscoaching.fr/">
            https://tdscoaching.fr/
          </Link>{" "}
        ...
        Thierry DA SILVA SEABRA – 5 rue jean zubietta 33400 Talence.
        <p className={styles.cgu__p}>
        ...
        <div ng-bind-html="rgpdHTML">
          <h3 className={styles.cgu__h3}>7.5 Types de données collectées</h3>
          <p className={styles.cgu__p}>
        ...
        <h2 className={styles.cgu__h2}>8. Notification d’incident</h2>
        <p className={styles.cgu__p}>
        ...
        <h3 className={styles.cgu__h3}>Sécurité</h3>
        <p className={styles.cgu__p}>
