    ...
    <main className={styles.modalite}>
      ...
      <div className={styles.modalite__container}>
        <div className={styles.modalite__article}>
          <div>
            <WhileInView>
              <p className={styles.modalite__article__div}>
                ...
                coach est un <strong>partenaire</strong> qui éclaire votre
                chemin et vous apporte de la motivation. L’accompagnement du
                coach est une véritable collaboration au sein de laquelle sera
                mis en œuvre votre changement.
                <br />
                Choisir un coach compétent et respectueux de votre personne est
                donc absolument essentiel. Un coach compétent est un{" "}
                <strong>professionnel</strong> qui pratique judicieusement et
                avec humanité l’art du questionnement et de l’accompagnement.
                <br />
                ...
                risque de transfert de ses propres problématiques sur son
                client.
              </p>
            </WhileInView>
          </div>
          <div>
            <WhileInView>
              <h2 className={styles.modalite__article__h2}>
          ...
          <div>
            ...
            <WhileInView>
              <p className={styles.modalite__article__div}>
                ...
                de coaching dureront 1h et seront espacées de 2 semaines.
                <br />
                Elles permettront de prendre conscience du fonctionnement actuel
                et des blocages.
                <br />
                Nous fixerons ensemble un <strong>objectif</strong>{" "}
                (c’est-à-dire ce sur quoi vous souhaitez avancer) qui soit
                clairement mesurable, contextualisé et ne dépendant que de vous.
                <br />
              </p>
            </WhileInView>
          </div>
            ...
            <div>
              <WhileInView>
                <p>
                  ...
                  accompagnement et sur le processus en cours. Au fur et à
                  mesure, nous explorerons de nouvelles pistes et de nouvelles
                  méthodes pour aborder les difficultés rencontrées. A ce titre,
                  le suivi comportera une séance « bilan intermédiaire ». Le
                  coaching vous permettra de prendre conscience de votre
                  potentiel et de vous aider à atteindre votre objectif. Vous
                  identifierez vos blocages et vos résistances, il vous aidera à
                  les dépasser. Souvent, le processus complet d’un coaching
                  classNameique se déroule sur un nombre de séances définies
                  préalablement, environ 10-12 séances. Pour des problématiques
                  simples, quelques séances peuvent suffire, environ 5 à 6
                  séances. Le coaching se terminera toujours par une séance de «
