      ...
      <div className={styles.about__container}>
        ...
        <div className={styles.about__article}>
          ...
          <p className={styles.about__article__p}>
            Aux cours de 30 années passées dans le management des organisations
            au sein du ministère de la défense, j’ai développé des compétences
            qui m’ont permis de m’adapter continuellement à de nouvelles
            fonctions et de nouveaux environnements.
            <br />
            ...
            aujourd’hui des personnes qui souhaitent prendre conscience de leurs
            forces et apprendre à se mobiliser dans un objectif de bien-être et
            de performance.
          </p>
        </div>
        <div className={styles.about__article}>
          <h2 className={styles.about__article__h2}>Ma vision du coaching :</h2>
          <p className={styles.about__article__p}>
