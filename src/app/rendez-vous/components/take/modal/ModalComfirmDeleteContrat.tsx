...
const ModalComfirmDeleteContrat = () => {
  ...
  useEffect(() => {
    ...
    if (userData && displayModalComfirmDeleteContrat === true) {
  ...
  if (isError) {
    ...
    if (userData) {
      if (userData.status === 200) {
        let link = `/assets/pdf/retractation-${userData.body.firstname}-${userData.body.lastname}.pdf`;
        ...
        {displayModalComfirmDeleteContrat === true && (
          <>
            ...
            >
              ...
              <p>
                Pour changer d&apos;offre vous devez faire une rétractation de
                votre contrat
              </p>
              {content}
            </motion.div>
