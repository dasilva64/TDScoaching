      ...
      if (user === null) {
        ...
        if (user.meetingId === null) {
          return NextResponse.json(
            {
              status: 400,
              message: "Vous n'avez aucun rendez-vous de pris",
            },
            {
              status: 400,
            }
          ...
          if (user.offre_test) {
            if (user.offre_test.hasCard) {
              return NextResponse.json(
                {
                  status: 400,
                  message: "Votre carte a deja été ajouter, veuillez réessayer",
                },
                {
                  status: 400,
                }
             ...
             return NextResponse.json(
                {
                  status: 400,
                  message: "L'offre n'a pas été trouvé, veuillez réessayer",
                },
                {
                  status: 400,
                }
