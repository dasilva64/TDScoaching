...
import styles from "./ModalCalendarAddMeetingDiscovery.module.scss"
import { useDispatch, useSelector } from "react-redux";
import interactionPlugin from "@fullcalendar/interaction";
import frLocale from "@fullcalendar/core/locales/fr";
import timeGridPlugin from "@fullcalendar/timegrid";

const ModalCalendarAddMeetingDiscovery = ({
    allData,
}: {
    allData: any;
}) => {
    ...
    const { displayModalCalendarAddMeetingRendezVous
    } = useSelector(
            ...
            <AnimatePresence>
                {displayModalCalendarAddMeetingRendezVous === true && (
                    <>
                        ...
                        />
                        <motion.div
                            className={styles.modalCalendarAddMeetingDiscovery}
                        ...
                        >
                            <button
                                type="button"
                                className={styles.modalCalendarAddMeetingDiscovery__btn}
                                onClick={() => closeModal()}
                            >
                                <Image
                                    className={styles.modalCalendarAddMeetingDiscovery__btn__img}
                            ...
                            <h2 className={`${styles.modalCalendarAddMeetingDiscovery__h1}`}>
                                Rendez-vous de découverte
                            </h2>
                            <p className={styles.modalCalendarAddMeetingDiscovery__p}>
...
export default ModalCalendarAddMeetingDiscovery