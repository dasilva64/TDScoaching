...
import styles from "./ModalCalendarEditMeetingDiscovery.module.scss"
...
const ModalCalendarEditMeetingDiscovery = ({ allData, startMeet }: any) => {
      ...
      <AnimatePresence>
        {displayModalCalendarEditMeetingRendezVous === true && (
          <>
            ...
            />
            <motion.div
              className={styles.modalCalendarEditMeetingDiscovery}
            ...
            >
              <button
                type="button"
                className={styles.modalCalendarEditMeetingDiscovery__btn}
                onClick={() => closeModal()}
              >
                <Image
                  className={styles.modalCalendarEditMeetingDiscovery__btn__img}
              ...
              <h2 className={`${styles.modalCalendarEditMeetingDiscovery__h1}`}>
                Modification du rendez-vous de découverte
              </h2>
              <p className={styles.modalCalendarEditMeetingDiscovery__p}>Selectionnez une date pour modifier votre rendez-vous</p>
              {isMobile === false && (
                <>
                  <FullCalendar
...
export default ModalCalendarEditMeetingDiscovery