...
import styles from "./ModalEditMeetingDiscovery.module.scss"
import Image from "@/app/components/image/Image";
import useSWRMutation from "swr/mutation";

const ModalEditMeetingDiscovery = ({ mutate, meeting, offre, userData }: any) => {
const { csrfToken } = useSelector((state: RootState) => state.csrfToken)
  ...
  const { trigger, data, reset, isMutating } = useSWRMutation(
    "/rendez-vous/components/test/modal/discovery/editMeeting/api/",
    fetchPost
  );
      ...
      <AnimatePresence>
        {displayModalEditMeetingRendezVous === true && (
          <>
            ...
            />
            <motion.div
              className={styles.modalEditMeetingDiscovery}
            ...
            >
              <button
                type="button"
                className={styles.modalEditMeetingDiscovery__return}
              ...
              <button
                type="button"
                className={styles.modalEditMeetingDiscovery__btn}
                onClick={() => closeModal()}
              >
                <Image
                  className={styles.modalEditMeetingDiscovery__btn__img}
              ...
              <h2 className={`${styles.modalEditMeetingDiscovery__h1}`}>
                Modification du rendez-vous de découverte
              </h2>
              <div
                className={`${styles.modalEditMeetingDiscovery__previous} ${styles.modalEditMeetingDiscovery__rdv}`}
              >
                <p className={styles.modalEditMeetingDiscovery__rdv__title}>
                  Ancien rendez-vous
                </p>
                <p className={styles.modalEditMeetingDiscovery__rdv__p}>
                  <Image
                    className={styles.modalEditMeetingDiscovery__rdv__p__img}
              ...
              <div
                className={`${styles.modalEditMeetingDiscovery__new} ${styles.modalEditMeetingDiscovery__rdv}`}
              >
                <p className={styles.modalEditMeetingDiscovery__rdv__title}>
                  Nouveau rendez-vous
                </p>
              ...
              <p className={styles.modalEditMeetingDiscovery__choose}>
              ...
              <form
                action=""
                method="POST"
                className={styles.modalEditMeetingDiscovery__form}
                onSubmit={(e) => {
              ...
              >
                <div className={styles.modalEditMeetingDiscovery__form__div}>
                  <label
                    className={`${typeCoaching.length > 0
                        ? styles.modalEditMeetingDiscovery__form__div__label__value
                        : styles.modalEditMeetingDiscovery__form__div__label
                      }`}
                    htmlFor=""
                  >
                    Type de coaching
                  </label>
                  <div className={styles.modalEditMeetingDiscovery__form__div__div}>
                    <select
                      className={
                        styles.modalEditMeetingDiscovery__form__div__div__select
                      }
                      name="typeCoaching"
                      id="typeCoaching"
                      value={typeCoaching}
                  ...
                  <div className={styles.modalEditMeetingDiscovery__form__div__error}>
                ...
                <input
                  ...
                  name="pseudo"
                  id="pseudo"
                  className={styles.modalEditMeetingDiscovery__form__hidden}
                  tabIndex={-1}
                  autoComplete="off"
                  onChange={(e) => {
                ...
                />
                <div className={styles.modalEditMeetingDiscovery__form__submit}>
                  {isMutating && (
                    <>
                      <button
                        disabled
                        className={
                          styles.modalEditMeetingDiscovery__form__submit__btn__load
                        }
                      >
                        <span
                          className={
                            styles.modalEditMeetingDiscovery__form__submit__btn__load__span
                          }
                        >
                          Chargement
                        </span>
                        ...
                        <div
                          className={
                            styles.modalEditMeetingDiscovery__form__submit__btn__load__arc
                          }
                        >
                          <div
                            className={
                              styles.modalEditMeetingDiscovery__form__submit__btn__load__arc__circle
                            }
                          ></div>
                        </div>
                      </button>
                  ...
                  {isMutating === false && (
                    <>
                      <button
                        className={styles.modalEditMeetingDiscovery__form__submit__btn}
                      >
...
export default ModalEditMeetingDiscovery