...
import styles from "./ModalCalendarEditMeetingFlash.module.scss"
...
const ModalCalendarEditMeetingFlash = ({ allData, startMeet }: any) => {
      ...
      <AnimatePresence>
        {displayModalCalendarEditMeetingRendezVous === true && (
          <>
            ...
            />
            <motion.div
              className={styles.modalCalendarEditMeetingFlash}
            ...
            >
              <button
                type="button"
                className={styles.modalCalendarEditMeetingFlash__btn}
                onClick={() => closeModal()}
              >
                <Image
                  className={styles.modalCalendarEditMeetingFlash__btn__img}
              ...
              <h2 className={`${styles.modalCalendarEditMeetingFlash__h1}`}>
                Modification du rendez-vous
              </h2>
              <p className={styles.modalCalendarEditMeetingFlash__p}>Selectionnez une date pour modifier votre rendez-vous</p>
              {isMobile === false && (
                <>
                  <FullCalendar
...
export default ModalCalendarEditMeetingFlash