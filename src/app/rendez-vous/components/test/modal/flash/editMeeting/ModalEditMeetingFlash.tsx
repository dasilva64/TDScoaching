...
import styles from "./ModalEditMeetingFlash.module.scss"
import Image from "@/app/components/image/Image";
import useSWRMutation from "swr/mutation";
import { mutate as globalMutate } from "swr";

const ModalEditMeetingFlash = ({ mutate, meeting, offre, userData }: any) => {
  ...
  const { trigger, data, reset, isMutating } = useSWRMutation(
    "/rendez-vous/components/test/modal/flash/editMeeting/api/",
    fetchPost
  );
      ...
      <AnimatePresence>
        {displayModalEditMeetingRendezVous === true && (
          <>
            ...
            />
            <motion.div
              className={styles.modalEditMeetingFlash}
            ...
            >
              <button
                type="button"
                className={styles.modalEditMeetingFlash__return}
              ...
              <button
                type="button"
                className={styles.modalEditMeetingFlash__btn}
                onClick={() => closeModal()}
              >
                <Image
                  className={styles.modalEditMeetingFlash__btn__img}
              ...
              <h2 className={`${styles.modalEditMeetingFlash__h1}`}>
                Modification du rendez-vous
              </h2>
              <div
                className={`${styles.modalEditMeetingFlash__previous} ${styles.modalEditMeetingFlash__rdv}`}
              >
                <p className={styles.modalEditMeetingFlash__rdv__title}>
                  Ancien rendez-vous
                </p>
                <p className={styles.modalEditMeetingFlash__rdv__p}>
                  <Image
                    className={styles.modalEditMeetingFlash__rdv__p__img}
              ...
              <div
                className={`${styles.modalEditMeetingFlash__new} ${styles.modalEditMeetingFlash__rdv}`}
              >
                <p className={styles.modalEditMeetingFlash__rdv__title}>
                  Nouveau rendez-vous
                </p>
              ...
              <p className={styles.modalEditMeetingFlash__choose}>
              ...
              <form
                action=""
                method="POST"
                className={styles.modalEditMeetingFlash__form}
                onSubmit={(e) => {
              ...
              >
                <div className={styles.modalEditMeetingFlash__form__div}>
                  <label
                    className={`${typeCoaching.length > 0
                      ? styles.modalEditMeetingFlash__form__div__label__value
                      : styles.modalEditMeetingFlash__form__div__label
                      }`}
                    htmlFor=""
                  >
                    Type de coaching
                  </label>
                  <div className={styles.modalEditMeetingFlash__form__div__div}>
                    <select
                      className={
                        styles.modalEditMeetingFlash__form__div__div__select
                      }
                      name="typeCoaching"
                      id="typeCoaching"
                      value={typeCoaching}
                  ...
                  <div className={styles.modalEditMeetingFlash__form__div__error}>
                ...
                <input
                  ...
                  name="pseudo"
                  id="pseudo"
                  className={styles.modalEditMeetingFlash__form__hidden}
                  tabIndex={-1}
                  autoComplete="off"
                  onChange={(e) => {
                ...
                />
                <div className={styles.modalEditMeetingFlash__form__submit}>
                  {isMutating && (
                    <>
                      <button
                        disabled
                        className={
                          styles.modalEditMeetingFlash__form__submit__btn__load
                        }
                      >
                        <span
                          className={
                            styles.modalEditMeetingFlash__form__submit__btn__load__span
                          }
                        >
                          Chargement
                        </span>
                        ...
                        <div
                          className={
                            styles.modalEditMeetingFlash__form__submit__btn__load__arc
                          }
                        >
                          <div
                            className={
                              styles.modalEditMeetingFlash__form__submit__btn__load__arc__circle
                            }
                          ></div>
                        </div>
                      </button>
                  ...
                  {isMutating === false && (
                    <>
                      <button
                        className={styles.modalEditMeetingFlash__form__submit__btn}
                      >
...
export default ModalEditMeetingFlash