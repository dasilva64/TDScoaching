...
import styles from "./ModalHistoriqueMeetingFlash.module.scss"
import Image from "@/app/components/image/Image";
import { useSelector, useDispatch } from "react-redux";

const ModalHistoriqueMeetingFlash = ({meet, offre}: any) => {
                                      ...
                                      >
                                        ...
                                        <div className={styles.table__body__tr__td__div__id}>
                                          ...
                                          {key === "Rdv dans l’offre" && (
                                            <>
                                              {data["numberOfMeeting"]} / 4
                                            </>
                                          )}
                                          {key === "Status du paiement" && (
                                            <>
                                              {data["status_payment"] === "pending" ? "En attente" : data["status_payment"] === "success" ? "Payé" : data["status_payment"] === "not_paid" ? "Pas payé" : "Erreur"}
                                            </>
                                          )}
                                        </div>
                                      </td>
...
export default ModalHistoriqueMeetingFlash