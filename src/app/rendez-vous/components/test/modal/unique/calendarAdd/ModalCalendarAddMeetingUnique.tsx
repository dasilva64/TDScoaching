...
import styles from "./ModalCalendarAddMeetingUnique.module.scss"

const ModalCalendarAddMeetingUnique = ({
    allData,
}: {
    allData: any;
}) => {
            ...
            <AnimatePresence>
                {displayModalCalendarAddMeetingRendezVous === true && (
                    <>
                        ...
                        />
                        <motion.div
                            className={styles.modalCalendarAddMeetingUnique}
                        ...
                        >
                            <button
                                type="button"
                                className={styles.modalCalendarAddMeetingUnique__btn}
                                onClick={() => closeModal()}
                            >
                                <Image
                                    className={styles.modalCalendarAddMeetingUnique__btn__img}
                            ...
                            <h2 className={`${styles.modalCalendarAddMeetingUnique__h1}`}>
                                Rendez-vous unique
                            </h2>
                            <p className={styles.modalCalendarAddMeetingUnique__p}>
...
export default ModalCalendarAddMeetingUnique