        ...
        <div className={styles.code__container}>
          <div className={styles.code__article}>
              ...
              <ul className={styles.code__article__div__ul}>
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    ...
                    <li>
                      ...
                      de ses clients (interdiction de s’immiscer dans la vie de
                ...
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    <li>
                      ...
                      psychiatre, psychologue...). Notez que dans certains cas,
                ...
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    ...
                    <li>
                      Le coach se doit d’être transparent concernant le montant
                      de ses honoraires.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    <li>
                      ...
                      <strong>une obligation de qualité de travail</strong>. Il
                      se doit de mettre en place tous les protocoles, techniques
                      et outils à disposition de son client /couple afin
                      d’obtenir le meilleur pour lui.
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    ...
                    <li>
                      ...
                      travail et à rester en évolution constante pour affirmer
                ...
                <li>
                  ...
                  <ul className={styles.code__article__div__ul__ul}>
                    <li>
                      Le coach n’a pas le droit d’entretenir des rapprochements
                      ou relations sexuelles avec ses clients.{" "}
            ...
            <p className={styles.code__article__div}>
              ...
              métier en conformité́ avec sa législation. Au travers cette
              présente charte, nous demandons à chaque coach conjugal de faire
              preuve de professionnalisme en accueillant les couples qui se
              confient à lui dans le plus grand respect dans un cadre de
